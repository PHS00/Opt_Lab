...
//	public static void quickSort2 (double[] arr, int low, int high, int[] order) {
...
//		if (low < j)
//			quickSort2(arr, low, j, order);
//		if (high > i)
//			quickSort2(arr, i, high, order);
//	}
	...
	public void solveMe() throws IOException {
		...
		try {
			...
			bw.newLine();
			System.out.println("추가 Lazy 제약식 개수 : " + LazyCallback.phase);
			bw.write("추가 Lazy 제약식 개수 : " + LazyCallback.phase);
			bw.newLine();
			System.out.println("추가 LazyCut 제약식 개수 : " + LazyCallback.etaPhase);
			bw.write("추가 LazyCut 제약식 개수 : " + LazyCallback.etaPhase);
			bw.newLine();
			// calculate gap rate
